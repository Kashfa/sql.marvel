...
-- Oops! Someone at CodeClan spelled Kate's name wrong! Change it to reflect the proper spelling
-- (change 'Kte Preston' to 'Kate Preston').
-- UPDATE people
...
-- The cinema has just heard that they will be holding an exclusive midnight showing of 'Guardians of the Galaxy 2'!!
-- Create a new entry in the 'movies' table to reflect this.
-- UPDATE movies
-- SET show_time

-- The cinema would also like to make the Guardian movies a back to back feature. Update the 'Guardians of the Galaxy'
